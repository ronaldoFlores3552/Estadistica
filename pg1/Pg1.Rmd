...
Comparativa de la cantidad de ropa en base al género

```{r}
table(dataMuestra$Genero, useNA = "always")

frec_gen<- c(63, 43, 373, 148, 373)
frec_gen

pie3D(frec_gen, labels=frec_gen, col= c("lightyellow", "lightblue","pink","orange", "green"))
legend("bottomleft", legend = c("Boys", "Girls", "Men", "Unisex", "Women"),
       fill =  c("lightyellow", "lightblue", "pink","orange", "green"))
```
